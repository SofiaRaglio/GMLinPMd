function [P_tot, T, tEC] = InputOutputMot(Params,Trials,target)
...
%   MUA matrix (mainly the Movement On, computing the matrix of the minimum delay 
...
Options.Time.CentralEvent = EC.RT;%EC.TOUCH_PERIPHERICAL;
