function [PerfInTime, Baseline] = FromPairOnMot(Params,selch, weights,Threshold,RandT);
...
%
%   PerfInTime = accuracy of classifier before and after Movement On (time interval given in Params.TestedT)
%   Baseline = accuracy of random classifier
%
EC=setEncodes;
[Data] = computeMUAandEvents(Params);
cndTrials = selectTrialWithConditions(Data.Trials, Data.Events, 4001:4042); 
