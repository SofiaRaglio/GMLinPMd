function [BestPerf, BestCh, MeanWeights, StdWeights, Threshold] = BestPerfAndChMot(varargin)
...
if Params.output==2
    [P_tot, T] = InputOutputMot(Params,CorrectTrials,0);
%     [P_tot1, T1] = InputOutputMot(Params,CorrectTrials,0);
%     [P_tot2, T2] = InputOutputMot(Params,ErrorTrials,0);
%     T2 = -T2;
%     P_tot = [P_tot1 P_tot2];
%     T = [T1 T2];
else
